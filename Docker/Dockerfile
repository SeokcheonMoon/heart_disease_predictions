...
ARG BRANCH_NAME=heart_disease_predictions
ARG DIR_NAME=heart_disease_predictions # 변경대상
...
RUN git clone https://github.com/SeokcheonMoon/heart_disease_predictions ${DIR_NAME}           # 변경대상
